...
| 08 | [0x0C](https://www.acmicpc.net/workbook/view/7315) | 백트래킹 | 가능성의 숲을 내려가며, 막힌 가지는 즉시 잘라 되돌아오는 탐험 - 15649,9663 | 🔄 | | | |
...
| 18 | [0x1D](https://www.acmicpc.net/workbook/view/10433) | 다익스트라 | BFS가 동심원처럼 “한 층씩” 퍼져나간다면, 다익스트라는 지형의 고저에 따라 “거리 파동이 굴절되며” 퍼져나가는 모습 - Multi-source Dijkstra / 1753, 1504, 1261, 11779, 1238, 1916, 17835, 20183, 24042 - 다시 | 🔄 | 🥈 🥇 | | |
...
> 🎯 **요약:**
> “상태를 정의하고 → 전이 규칙을 세우고 → 종료 조건과 가지치기를 넣고 →
> 적절한 탐색 전략으로 순회한다.”
